                                                                     ...
                                                                     uint16_t, uint32_t)
{
    ...
    CHECK(sys::bnumeric_cast<uint16_t>(65535.0f /* NOLINT(readability-magic-numbers) */, unsafe) == 65535);
    CHECK(sys::bnumeric_cast<int16_t>(-10.5f /* NOLINT(readability-magic-numbers) */, unsafe) == -10);
    ...
    CHECK(sys::bnumeric_cast<uint16_t>(65535.1f /* NOLINT(readability-magic-numbers) */, unsafe) == 65535);
    ...
    CHECK(sys::bnumeric_cast<TestType>(-1000000000000000000.0f /* NOLINT(readability-magic-numbers) */, unsafe) == std::numeric_limits<TestType>::lowest());
...
{
    CHECK(sys::bnumeric_cast<int32_t>(10 /* NOLINT(readability-magic-numbers) */).expect() == 10);
    CHECK(sys::bnumeric_cast<uint8_t>(255 /* NOLINT(readability-magic-numbers) */).expect() == 255);
    CHECK(sys::bnumeric_cast<int64_t>(-42).expect() == -42);
    CHECK(sys::bnumeric_cast<uint16_t>(65535.0f /* NOLINT(readability-magic-numbers) */).expect() == 65535);
    CHECK(sys::bnumeric_cast<int16_t>(-10.5f /* NOLINT(readability-magic-numbers) */).expect() == -10);

    CHECK(sys::bnumeric_cast<uint8_t>(300 /* NOLINT(readability-magic-numbers) */).operator!());
    CHECK(sys::bnumeric_cast<uint8_t>(-1 /* NOLINT(readability-magic-numbers) */).operator!());
    CHECK(sys::bnumeric_cast<int8_t>(128 /* NOLINT(readability-magic-numbers) */).operator!());
    CHECK(sys::bnumeric_cast<uint16_t>(100000 /* NOLINT(readability-magic-numbers) */).operator!());
    CHECK(sys::bnumeric_cast<uint16_t>(65535.1f /* NOLINT(readability-magic-numbers) */).operator!());
