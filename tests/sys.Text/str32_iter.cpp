...
TEST_CASE("`sys::str32_iter<...>` Exhaustive Iteration", "[sys.Text][str32_iter]")
{
    SECTION("UTF-8 Iteration (Valid)")
    {
    ...
    SECTION("UTF-16 Iteration (Valid)")
    {
    ...
    SECTION("Pathological UTF-8 Sequences")
    {
