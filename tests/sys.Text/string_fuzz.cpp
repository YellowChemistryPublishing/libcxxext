...
{
    CHECK(rc::check([](const std::string& input) -> void
    {
...
{
    CHECK(rc::check([](const std::vector<u16::underlying_type>& input) -> void
    {
...
{
    CHECK(rc::check([](const std::vector<u32::underlying_type>& input) -> void
    {
