...
extern "C" void* ::sys::platform::task_operator_new(size_t sz)
{
    return ::operator new(sz); // NOLINT(misc-include-cleaner)
}
extern "C" void ::sys::platform::task_operator_delete(void* ptr)
{
    ::operator delete(ptr); // NOLINT(misc-include-cleaner)
}

extern "C" void ::sys::platform::launch_async(void* addr)
{
