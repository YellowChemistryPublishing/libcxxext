...
add_library(stdc++inc INTERFACE)
target_precompile_headers(stdc++inc INTERFACE
    ...
    $<$<COMPILE_FEATURES:cxx_std_26>:[[<contracts>]]>
    ...
    [[<cassert>]]
    [[<cerrno>]]
    $<$<COMPILE_FEATURES:cxx_std_26>:[[<debugging>]]>
    ...
    [[<forward_list>]]
    $<$<COMPILE_FEATURES:cxx_std_26>:[[<hive>]]>
    $<$<COMPILE_FEATURES:cxx_std_26>:[[<inplace_vector>]]>
    [[<list>]]
    [[<map>]]
    $<$<COMPILE_FEATURES:cxx_std_23>:[[<mdspan>]]>
    [[<queue>]]
    [[<set>]]
    ...
    [[<cmath>]]
    [[<complex>]]
    $<$<COMPILE_FEATURES:cxx_std_26>:[[<linalg>]]>
    $<$<COMPILE_FEATURES:cxx_std_20>:[[<numbers>]]>
    [[<random>]]
    $<$<COMPILE_FEATURES:cxx_std_26>:[[<simd>]]>
    [[<valarray>]]
    ...
    [[<condition_variable>]]
    [[<future>]]
    $<$<COMPILE_FEATURES:cxx_std_26>:[[<hazard_pointer>]]>
    $<$<COMPILE_FEATURES:cxx_std_20>:[[<latch>]]>
    [[<mutex>]]
    $<$<COMPILE_FEATURES:cxx_std_26>:[[<rcu>]]>
