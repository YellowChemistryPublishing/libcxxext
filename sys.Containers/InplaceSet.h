...
namespace sys
{
    ...
    public:
        ...
        [[nodiscard]] size_t size() const { return this->_size; }             /**< Query the number of elements in the set. */
        [[nodiscard]] consteval static size_t capacity() { return Capacity; } /**< Query the capacity of the set. */
