...
#define _nowarn_begin_conv_comp()                              \
    _nowarn_begin_clang();                                     \
    _nowarn_clang(_clwarn_clang_conversion);                   \
    _nowarn_clang(_clwarn_clang_sign_conversion);              \
    _nowarn_clang(_clwarn_clang_float_conversion);             \
    _nowarn_clang(_clwarn_clang_double_promotion);             \
    _nowarn_clang(_clwarn_clang_sign_compare);                 \
    _nowarn_clang(_clwarn_clang_implicit_int_float_conversion)
...
#define _nowarn_begin_deprecated()          \
    _nowarn_begin_clang();                  \
    _nowarn_clang(_clwarn_clang_deprecated)
...
#define _nowarn_begin_c_cast()                  \
    _nowarn_begin_clang();                      \
    _nowarn_clang(_clwarn_clang_old_style_cast)
...
#define _nowarn_begin_use_after_free()                       \
    _nowarn_begin_clang();                                   \
    _nowarn_clang(_clwarn_clang_block_capture_autoreleasing)
...
#define _nowarn_begin_unreachable()               \
    _nowarn_begin_clang();                        \
    _nowarn_clang(_clwarn_clang_unreachable_code)
...
#define _nowarn_begin_conv_comp()              \
    _nowarn_begin_gcc();                       \
    _nowarn_gcc(_clwarn_gcc_conversion);       \
    _nowarn_gcc(_clwarn_gcc_sign_conversion);  \
    _nowarn_gcc(_clwarn_gcc_float_conversion); \
    _nowarn_gcc(_clwarn_gcc_double_promotion); \
    _nowarn_gcc(_clwarn_gcc_sign_compare)
#undef _nowarn_end_conv_comp
...
#define _nowarn_begin_deprecated()      \
    _nowarn_begin_gcc();                \
    _nowarn_gcc(_clwarn_gcc_deprecated)
#undef _nowarn_end_deprecated
...
#define _nowarn_begin_c_cast()      \
    _nowarn_begin_gcc();            \
    _nowarn_gcc(_clwarn_gcc_c_cast)
#undef _nowarn_end_c_cast
...
#define _nowarn_begin_use_after_free()      \
    _nowarn_begin_gcc();                    \
    _nowarn_gcc(_clwarn_gcc_use_after_free)
#undef _nowarn_end_use_after_free
...
#define _nowarn_begin_conv_comp()                                                                                           \
    _nowarn_begin_msvc();                                                                                                   \
    _nowarn_msvc(_clwarn_msvc_overflow_in_floating_point_constant_arithmetic);                                              \
    _nowarn_msvc(_clwarn_msvc_operator_signed_integral_constant_overflow);                                                  \
    _nowarn_msvc(_clwarn_msvc_operator_overflow_in_constant_division_undefined_behavior);                                   \
    _nowarn_msvc(_clwarn_msvc_overflow_assigning_value_to_bit_field_that_can_only_hold_values_from_min_value_to_max_value); \
    _nowarn_msvc(_clwarn_msvc_overflow_in_constant_arithmetic);                                                             \
    _nowarn_msvc(_clwarn_msvc_identifier_conversion_from_type1_to_type2_possible_loss_of_data);                             \
    _nowarn_msvc(_clwarn_msvc_conversion_type_conversion_from_type1_to_type2_possible_loss_of_data);                        \
    _nowarn_msvc(_clwarn_msvc_variable_conversion_from_size_t_to_type_possible_loss_of_data);                               \
    _nowarn_msvc(_clwarn_msvc_conversion_truncation_from_type1_to_type2_4305);                                              \
    _nowarn_msvc(_clwarn_msvc_conversion_truncation_of_constant_value)
#undef _nowarn_end_conv_comp
...
#define _nowarn_begin_deprecated()                                        \
    _nowarn_begin_msvc();                                                 \
    _nowarn_msvc(_clwarn_msvc_deprecated_declaration_deprecation_message)
#undef _nowarn_end_deprecated
...
#define _nowarn_begin_unreachable()             \
    _nowarn_begin_msvc();                       \
    _nowarn_msvc(_clwarn_msvc_unreachable_code)
#undef _nowarn_end_unreachable
